                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${subject.syllabus}" var="syllabus">
                                                                <tr>
                                                                    ...
                                                                    <td><input id="" type="checkbox" ${syllabus.isActive ? 'checked' : ''} name="isActive" disabled="disabled"></td>
                                                                    <td><input id="" type="checkbox" ${syllabus.isApproved ? 'checked' : ''} name="isApproved" disabled="disabled"></td>
                                                                    <td>
