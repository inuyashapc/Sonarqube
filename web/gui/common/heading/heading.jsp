                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right ">
                                    <ul class="d-flex flex-column">
                                        <c:if test="${account.role.rid == 5 || account.role.rid == 6}">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="main-menu">
                        <ul>
                            <li><a href="http://localhost:9999/SWP391-G2/home">Home</a>
                            </li>
                            <li><a href="search?type=curriculum">All Curriculum</a>
                            <li><a href="search?type=syllabus">All Syllabus</a>
                            <li><a href="search?type=preRequisite">All PreRequisite</a>
                            <li><a href="search?type=corollary">All Corollary</a>
                                <c:if test="${account.role.rname == 'Admin'}">
                                    <a href="dashboard">System Management</a>
                            </c:if><li>
                            </li>
                            </li>
                        </ul>
