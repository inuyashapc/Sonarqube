                                                ...
                                                <table id="" class="table table-hover" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th onclick="sortByType('${sort == "" ? 'tag_down' : sort eq 'tag_up' ? 'tag_down': 'tag_up'}')">Combo Tag <span class="fa ${sort == "" ? 'fa-angle-up' : sort eq 'tag_up' ? 'fa-angle-up' : 'fa-angle-down'}"></span></th>
