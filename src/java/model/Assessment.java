...
public class Assessment {
    ...
    public Assessment(int assid, int slbid, String category, String type, int part, float weight, String completionCriteria, String duration, String questionType, String noQuestion, String knowledgeSkill, String gradingGuide, String note, boolean isActive, List<AssessmentDetail> detail) {
        this.assid = assid;
        this.slbid = slbid;
