...
public class Material {
    ...
    public Material(int mid, int slbid, String description, String author, String publisher, Date publishedDate, String edition, String ISBN, boolean isMainMaterial, boolean isHardCopy, boolean isOnline, boolean isActive, String note) {
        this.mid = mid;
        this.slbid = slbid;
