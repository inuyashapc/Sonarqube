...
public class Session {
    ...
    public Session(int sesid, int slbid, int sesNo, String topic, String learningTeachingType, String ITU, String studentMaterial, String dowload, String studentTask, String urls, String note, boolean isActive, List<Question> question) {
        this.sesid = sesid;
        this.slbid = slbid;
        this.sesNo = sesNo;
        this.topic = topic;
